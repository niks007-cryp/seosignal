...
import { CURRENCIES, formatBudgetAmount, type CurrencyCode, type LeadInput, type QualificationReport, type QualificationSignal } from "../../../shared/qualification";
  ...
  return <article className="report-shell" id="qualification-report" aria-labelledby="report-title">
    <header className="report-header">
      ...
      <div className="report-opening">
        <div className="company-block"><p className="report-eyebrow">LEAD SIGNAL</p><h2 id="report-title">{lead.company}</h2><a href={lead.website} target="_blank" rel="noreferrer">{lead.website.replace(/^https?:\/\//, "")}<ExternalLink size={14} /></a><p className="report-budget">Monthly budget <strong>{monthlyBudget}</strong></p><p className="generated-date">Generated {generated}</p></div>
